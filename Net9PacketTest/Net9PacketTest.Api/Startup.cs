...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddSwaggerGen(c =>
        {
            ...
            var filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Net9PacketTest.Api.xml");
    ...
    public void Configure(IApplicationBuilder app, IHostEnvironment env, IHostApplicationLifetime appLifetime)
    {
        ...
        app.UseSwaggerUI(x =>
        {
            x.SwaggerEndpoint("v1/swagger.json", $"Net9PacketTest Service");
        });
